...
from instagrapi.mixins.insights import DATA_ORDERING, POST_TYPE, TIME_FRAME

from dependencies import ClientStorage, get_clients

router = APIRouter(
    prefix="/insights", tags=["insights"], responses={404: {"description": "Not found"}}
)


@router.post("/media_feed_all", response_model=List[Dict])
async def media_feed_all(
    sessionid: str = Form(...),
