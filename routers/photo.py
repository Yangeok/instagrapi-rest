...
from helpers import (
    photo_upload_post,
    photo_upload_story_as_photo,
    photo_upload_story_as_video,
)
...
async def photo_upload_to_story_by_url(
    sessionid: str = Form(...),
    url: AnyHttpUrl = Form(...),
    as_video: Optional[bool] = Form(False),
    caption: Optional[str] = Form(""),
...
async def photo_upload(
    ...
    for usertag in usertags:
        ...
        usernames_tags.append(
            Usertag(user=usertag_json["user"], x=usertag_json["x"], y=usertag_json["y"])
        )
