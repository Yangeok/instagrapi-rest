...
async def user_info_by_username(
    sessionid: str = Form(...),
    username: str = Form(...),
    use_cache: Optional[bool] = Form(True),
    clients: ClientStorage = Depends(get_clients),
...
async def user_id_from_username(
    sessionid: str = Form(...),
    username: str = Form(...),
    clients: ClientStorage = Depends(get_clients),
) -> int:
...
async def username_from_user_id(
    sessionid: str = Form(...),
    user_id: int = Form(...),
    clients: ClientStorage = Depends(get_clients),
) -> str:
...
async def user_remove_follower(
    sessionid: str = Form(...),
    user_id: int = Form(...),
    clients: ClientStorage = Depends(get_clients),
) -> bool:
...
async def mute_posts_from_follow(
    sessionid: str = Form(...),
    user_id: int = Form(...),
...
async def unmute_posts_from_follow(
    sessionid: str = Form(...),
    user_id: int = Form(...),
    clients: ClientStorage = Depends(get_clients),
) -> bool:
...
async def unmute_stories_from_follow(
    sessionid: str = Form(...),
    user_id: int = Form(...),
    clients: ClientStorage = Depends(get_clients),
) -> bool:
